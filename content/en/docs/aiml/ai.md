---
title: "Memoria and Artificial Intelligence"
description: ""
lead: ""
...
2. Let $|S|$ is a length of string $S$ in bits. If for some object $O1$, $K(S1) << |S1|$, then we say that $S1$ is **highly compressible** or **simple**. If $K(S1) \propto |S1|$, then we say that $S1$ is **uncompressible** or **complex**. There are may intermediate descriptional complexity classes between highly compressible and uncompressible strings.
